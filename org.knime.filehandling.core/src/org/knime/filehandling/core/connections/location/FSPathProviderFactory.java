...
public abstract class FSPathProviderFactory implements AutoCloseable {
    ...
    public static FSPathProviderFactory newFactory(final Optional<FSConnection> portObjectConnection, final FSLocationSpec fsLocationSpec) {
        ...
        switch (choice) {
            ...
            case CUSTOM_URL_FS:
                return createCustomURLPathProviderFactory(fsLocationSpec);
            case CONNECTED_FS:
                return createConnectedFSPathProviderFactory(portObjectConnection, fsLocationSpec);
            default:
                throw new IllegalArgumentException(String.format("Cannot create FSPathProviderFactory for NULL FSLocation."));
        }
    }
    ...
    private static FSPathProviderFactory createCustomURLPathProviderFactory(final FSLocationSpec fsLocationSpec) {
    ...
    static FSConnection createRelativeToFSConnection(final FSLocationSpec fsLocationSpec) {
