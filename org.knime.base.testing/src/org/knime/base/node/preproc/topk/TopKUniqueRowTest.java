...
public class TopKUniqueRowTest {
    ...
    public void testTop2DescendingOrderedInput() {
        ...
        m_uniqueRowSelector = createRowSelector(2);
        m_input = createInputRows(3, 3, 2, 2, 1, 1);
        ...
        expectedOutput.add(new DefaultRow(RowKey.createRowKey(2L), IntCellFactory.create(2)));
        expectedOutput.add(new DefaultRow(RowKey.createRowKey(3L), IntCellFactory.create(2)));
        expectedOutput.add(new DefaultRow(RowKey.createRowKey(0L), IntCellFactory.create(3)));
    ...
    public void testTop2RandomOrderedInput() {
        ...
        m_input = createInputRows(1, 2, 2, 1, 2, 1, 4);
        ...
        expectedOutput.add(new DefaultRow(RowKey.createRowKey(0L), IntCellFactory.create(1)));
        expectedOutput.add(new DefaultRow(RowKey.createRowKey(3L), IntCellFactory.create(1)));
        expectedOutput.add(new DefaultRow(RowKey.createRowKey(5L), IntCellFactory.create(1)));
        expectedOutput.add(new DefaultRow(RowKey.createRowKey(1L), IntCellFactory.create(2)));
        expectedOutput.add(new DefaultRow(RowKey.createRowKey(2L), IntCellFactory.create(2)));
        expectedOutput.add(new DefaultRow(RowKey.createRowKey(4L), IntCellFactory.create(2)));
        expectedOutput.add(new DefaultRow(RowKey.createRowKey(6L), IntCellFactory.create(4)));
